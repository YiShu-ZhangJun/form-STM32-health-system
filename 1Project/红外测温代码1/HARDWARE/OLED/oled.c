...
//==============================================================
//��������LED_ShowCHinese16x16(u8 x,u8 y,u8 num,u8 (*buf)[16]) numΪ�ڼ����֣�bufΪ�������飨����Ϊ16*16��
//����������д��һ������
//��������ʾ��λ�ã�x,y����yΪҳ��Χ0��3��Ҫ��ʾ������
//���أ���
//============================================================== 
...
#define OLED_W_SCL(x)		GPIO_WriteBit(GPIOB, OLED_SCK, (BitAction)(x))
...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = OLED_SCK|OLED_SDA;	 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //�������
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//�ٶ�50MHz
 	GPIO_Init(GPIOB, &GPIO_InitStructure);	  //��ʼ��GPIOB8,9
 	GPIO_SetBits(GPIOB,OLED_SCK|OLED_SDA);	
	...
	// GPIO_InitStructure.GPIO_Pin = OLED_SCK;
...
void display(void)  
{	
	OLED_ShowCHinese16x16(20,0,0,LOGO);//��
	OLED_ShowCHinese16x16(36,0,1,LOGO);//��
	OLED_ShowCHinese16x16(52,0,2,LOGO);//С
	OLED_ShowCHinese16x16(68,0,3,LOGO);//ʦ
    OLED_ShowCHinese16x16(84,0,4,LOGO);//��
	OLED_ShowCHinese16x16(0,2,5,LOGO); //��
	OLED_ShowCHinese16x16(16,2,6,LOGO);//��
