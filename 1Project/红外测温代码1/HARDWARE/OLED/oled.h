 ...
 * @Date: 2024-11-06 21:30:23
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2024-11-07 11:10:43
 * @Description: 请填写简介
 */
#ifndef __OLED_H
#define __OLED_H	
...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,OLED_SCK)//SCL
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,OLED_SCK)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,OLED_SDA)//SDA
#define OLED_SDIN_Set() GPIO_SetBits(GPIOB,OLED_SDA)
