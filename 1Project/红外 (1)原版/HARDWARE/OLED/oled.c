...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = OLED_SDA_GPIO_Pin|OLED_SCL_GPIO_Pin;	 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	GPIO_Init(GPIOB, &GPIO_InitStructure);	  //初始化GPIOB8,9
 	GPIO_SetBits(GPIOB,OLED_SDA_GPIO_Pin|OLED_SCL_GPIO_Pin);	
	Delay(20000); 
	OLED_WR_Byte(0xAE,OLED_CMD);//--display off
 ...
 unsigned char LOGO1[][16]=
{
	...
	OLED_ShowCHinese16x16(80,2,0,TempCompany);
		OLED_ShowCHinese16x16(0,0,0,LOGO1);		
		OLED_ShowCHinese16x16(16,0,1,LOGO1);
		OLED_ShowCHinese16x16(32,0,2,LOGO1);
		OLED_ShowCHinese16x16(48,0,3,LOGO1);
		OLED_ShowCHinese16x16(64,0,4,LOGO1);
		OLED_ShowCHinese16x16(80,0,5,LOGO1);
		OLED_ShowCHinese16x16(96,0,6,LOGO1);
		OLED_ShowCHinese16x16(112,0,7,LOGO1);
		OLED_ShowCHinese16x16(0,2,7,LOGO1); 
		OLED_ShowCHinese16x16(16,2,8,LOGO1);
        OLED_ShowCHinese16x16(0,4,9,LOGO1); 
		OLED_ShowCHinese16x16(16,4,10,LOGO1);
        OLED_ShowCHinese16x16(0,6,11,LOGO1); 
		OLED_ShowCHinese16x16(16,6,12,LOGO1);
}
void Safe(void)
{
...
void MoShiYi(void)//模式1
{
	unsigned char LOGO3[][16]=
	{
      ...
      0x10,0x10,0x10,0x10,0x10,0x18,0x10,0x00}
		...
		OLED_ShowCHinese16x16(80,4,0,LOGO3); 
		OLED_ShowCHinese16x16(96,4,1,LOGO3);
	    OLED_ShowCHinese16x16(112,4,2,LOGO3); 
}



void MoShiEr(void)//模式2
{
	unsigned char LOGO3[][16]=
	{
      ...
      0x10,0x10,0x10,0x10,0x10,0x18,0x10,0x00}
		...
		OLED_ShowCHinese16x16(80,4,0,LOGO3); 
		OLED_ShowCHinese16x16(96,4,1,LOGO3); 
		OLED_ShowCHinese16x16(112,4,3,LOGO3);
}
